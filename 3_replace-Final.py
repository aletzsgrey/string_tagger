#Use Function that sorts the dictionary by key lenght
from dictionarySorter import sorterDicLen
...
def main():
    '''
    In this version we use a method for sorting and getting a dictionary
    with a decremental key order. This Fix the issue with processing shorter
    patterns included into bigger patterns. 
    '''
    tagsDict ={
    ...
    print("first Dict:")
    print(tagsDict)
    #First we order the dictionary by reverse lenght 
    tagsDict1 = sorterDicLen(tagsDict) 
    print("Updated Dict:")
    print(tagsDict)
